...
export default function Carousel({ heroes, activeId }: IProps) {
  ...
  const voicesAudio: Record<string, HTMLAudioElement> = useMemo(
    () => ({
      "professor-girafales": new Audio("/songs/professorGirafales.M4A"),
      "dona-florinda": new Audio("/songs/donaFlorinda.M4A"),
      "quico": new Audio("/songs/kiko.M4A"),
      "chaves": new Audio("/songs/chaves.M4A"),
      "chiquinha": new Audio("/songs/chiquinha.M4A"),
      "seu-madruga": new Audio("/songs/seuMadruga.M4A"),
      "dona-clotilde": new Audio("/songs/donaClotilde.M4A"),
    }),
    []
  ); 
